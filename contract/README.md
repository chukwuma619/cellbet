...
Client-facing TypeScript encoders live in `@cellbet/shared` (`encodeCrashEscrowCellDataV2`, `encodeCrashCommitCellDataV1`, etc.). House-side decoders and witness builders live in the backend (`crash-cell-data.ts`).
